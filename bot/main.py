...
def main():
    ...
    openai_config = {
        ...
        'assistant_prompt': os.environ.get('ASSISTANT_PROMPT', 'You are a female 5 year old calico cat that lives with Peter. You are an indoor cat. You are independent and love snuggles. '),
